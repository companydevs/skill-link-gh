...
class _ReelsScreenState extends ConsumerState<ReelsScreen> {
  ...
  // Watch-time tracking for recommendation engine
            ...
            data: (reels) {
              ...
              return RefreshIndicator(
                ...
                child: PageView.builder(
                  ...
                  onPageChanged: (index) {
                    // Track view/skip for the reel we just left
                    if (_currentReelIndex < reels.length) {
                      final prevReel = reels[_currentReelIndex];
                      ref
                          .read(reelsNotifierProvider.notifier)
                          .trackView(
                            prevReel.id,
                            watchSeconds: _watchStopwatch.elapsed.inSeconds,
                          );
                    }
                    _watchStopwatch
                      ..reset()
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Stack(
                      ...
                      children: [
                        ...
                        // Interaction overlay — counts come from live notifier state
                        Positioned(
                          right: 10,
                          bottom: 24,
