...
class _SearchAndDiscoveryScreenState extends State<SearchAndDiscoveryScreen> {
  ...
  Future<void> _loadArtisans() async {
    ...
    try {
      final list = await _artisanRepository.fetchArtisans(
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Top-right: search + filter buttons
          Positioned(
